...
function LogoutIcon(props: SVGAttributes<any>) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
...
function ProfileIcon(props: SVGAttributes<any>) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
...
function FavouriteIcon(props: SVGAttributes<any>) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
...
function OrdersIcon(props: SVGAttributes<any>) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
...
function AddressesIcon(props: SVGAttributes<any>) {
  return (
    <svg
      {...props}
      xmlns='http://www.w3.org/2000/svg'
